...
@section('title', trans('locale.profile.create'))
	...
	<div class="card-body card-dashboard">
		<form action="{{ route('profiles.store') }}" method="POST">
			...
			<fieldset class="form-group">
				...
				<input name="favour_color" type="color" class="form-control favour-color" placeholder="@lang('locale.profile.favourColor')" value="{{ old('favour_color') }}">
			...
			<div class="text-right">
				<button class="btn btn-primary">@lang('locale.profile.save')</button>
			</div>
		</form>
	</div>
	</div>
